...
const initialAgents: Agent[] = [
  {
    "name": "Founder & CEO",
    "rating": "7.5",
    "problem": "Lacks core competitive edge in automated flight/hotel lock-in compared to traditional OTAs.",
    "opportunity": "Reposition as a premium curation platform connecting with boutique providers.",
    "rec": "Focus on human-fulfilled agent console speed."
  },
  {
    "name": "VC Investor",
    "rating": "6.5",
    "problem": "High initial AI API costs and low visible conversion loops to cover CAC.",
    "opportunity": "B2B SaaS licensing of DNA matching module to regional travel agencies.",
    "rec": "Adopt deterministic local rules over LLM prompts for itinerary parsing."
  },
  {
    "name": "Chief Product Officer",
    "rating": "7.0",
    "problem": "Completely missing Bundle Builder front-end; users cannot customize flights/hotels seamlessly.",
    "opportunity": "Design visual card-swapping timelines for hotels and activities.",
    "rec": "Implement the DB-modeled 'bundle_templates' table in UI."
  },
  {
    "name": "CTO",
    "rating": "7.2",
    "problem": "No real-time synchronization between Supabase database state and local fallback JSONs.",
    "opportunity": "Implement edge-cache CDN layer for destinations and experiences database queries.",
    "rec": "Setup database triggers to automatically sync cached static JSON files."
  },
  {
    "name": "Chief Marketing Officer",
    "rating": "6.8",
    "problem": "No viral sharing loops for generated itineraries (e.g. public links).",
    "opportunity": "Create a 'Share DNA Profile' badge for Instagram and WhatsApp.",
    "rec": "Enable public view of itineraries without gating by quiz registration."
  },
  {
    "name": "Chief Revenue Officer",
    "rating": "6.0",
    "problem": "Monetization is purely transactional; no upselling on insurance or local guides.",
    "opportunity": "Partner with global insurance providers and local experience suppliers for split-revenue commissions.",
    "rec": "Embed affiliate flight & transport tags on checkout screens."
  },
  {
    "name": "Senior Frontend Engineer",
    "rating": "7.5",
    "problem": "Next.js middleware warning on convention deprecation. CSS styling lacks interactive feedback.",
    "opportunity": "Transition to Tailwind v4 transitions and standardized border utilities.",
    "rec": "Refactor middleware file convention and clean up unused CSS tokens."
  },
  {
    "name": "Senior Backend Engineer",
    "rating": "7.8",
    "problem": "RLS policies for write operations are wide open for admin roles without proper check validations.",
    "opportunity": "Refactor helper security definer functions for row level checks.",
    "rec": "Enforce strict checks on `is_admin()` helper queries."
  },
  {
    "name": "AI Architect",
    "rating": "6.5",
    "problem": "No RAG caching layers. Every AI validation triggers slow LLM evaluations.",
    "opportunity": "Vectorize experiences in pgvector database and run semantic search filters.",
    "rec": "Use cached validation reports for recurring itineraries."
  },
  {
    "name": "ML Engineer",
    "rating": "6.0",
    "problem": "Proximity matching engine relies on basic dot-product matrix multiplication without weights update.",
    "opportunity": "Train a light regression model on user booking signals to adjust weights.",
    "rec": "Implement feedback updates to dimension weights config."
  },
  {
    "name": "Database Architect",
    "rating": "7.0",
    "problem": "No unique constraint on destination question templates category combinations.",
    "opportunity": "Improve table integrity with compound indexes.",
    "rec": "Add unique index on `(category, applies_to_experience_category)` in `destination_question_templates`."
  },
  {
    "name": "Security Engineer",
    "rating": "7.5",
    "problem": "Plaintext WhatsApp lead phone logging without mask controls.",
    "opportunity": "Implement encryption on customer contact information at database level.",
    "rec": "Encrypt phone and email in the leads database table."
  },
  {
    "name": "DevOps Engineer",
    "rating": "8.0",
    "problem": "Vercel builds are fast but lack integration test validations.",
    "opportunity": "Configure GitHub actions to validate SQL migrations before Vercel deploy.",
    "rec": "Add automated lint checks on migrations."
  },
  {
    "name": "QA Engineer",
    "rating": "6.8",
    "problem": "Soft-delete architectures are untested on database level cascading deletes.",
    "opportunity": "Write automated tests for cascading soft-deletes.",
    "rec": "Develop a validator test script for logical soft delete queries."
  },
  {
    "name": "Performance Engineer",
    "rating": "7.2",
    "problem": "Unsplash heavy images block initial render times.",
    "opportunity": "Generate and store optimized WebP thumbnails locally.",
    "rec": "Ensure all pages load local WebP files instead of external unsplash sources."
  },
  {
    "name": "UX Researcher",
    "rating": "7.0",
    "problem": "Teaser screen interrupts questionnaire unexpectedly.",
    "opportunity": "Reposition teaser as a loading screen after questionnaire completes.",
    "rec": "Redesign questionnaire flow step progression."
  },
  {
    "name": "UI Designer",
    "rating": "7.8",
    "problem": "Admin panel dashboard KPI grids feel static and dry.",
    "opportunity": "Introduce premium micro-animations for card transitions.",
    "rec": "Use framer-motion or CSS keyframe animations for KPIs."
  },
  {
    "name": "CRO Expert",
    "rating": "6.5",
    "problem": "Gated questionnaire account creation blocks drop-off rates.",
    "opportunity": "Allow users to view itinerary draft before requesting signup.",
    "rec": "Move account creation to booking checkouts."
  },
  {
    "name": "Accessibility Expert",
    "rating": "6.0",
    "problem": "Low color contrast ratio on marigold badges in white background.",
    "opportunity": "Increase typography contrast and add aria-labels to buttons.",
    "rec": "Standardize theme colors for AA accessibility rating."
  },
  {
    "name": "Mobile UX Specialist",
    "rating": "7.5",
    "problem": "Slider elements on questionnaire are difficult to slide on mobile touch screens.",
    "opportunity": "Use native touch gestures and larger hit-targets for mobile sliders.",
    "rec": "Enlarge questionnaire slider thumb UI."
  },
  {
    "name": "Luxury Travel Consultant",
    "rating": "7.2",
    "problem": "High-end luxury packages match mid-tier budget hotels.",
    "opportunity": "Enforce strict hotel matching based on luxury slider score > 80.",
    "rec": "Filter hotels based on selected luxury criteria."
  },
  {
    "name": "Budget Travel Consultant",
    "rating": "8.0",
    "problem": "Value-conscious users see high-priced signature experiences.",
    "opportunity": "Implement price-band filtering on matching engine query.",
    "rec": "Exclude high price-band experiences for value-conscious users."
  },
  {
    "name": "Family Travel Expert",
    "rating": "6.8",
    "problem": "No child age suitability filtering in itineraries.",
    "opportunity": "Filter out age-inappropriate items (e.g. nightlife bar tours) for family group types.",
    "rec": "Check experience age suitability tags during itinerary creation."
  },
  {
    "name": "Honeymoon Specialist",
    "rating": "7.5",
    "problem": "Honeymoon packages lack premium private details like romantic spa upgrades.",
    "opportunity": "Upsell exclusive couple experiences directly in the summary.",
    "rec": "Prioritize romantic tag matches for couples."
  },
  {
    "name": "Adventure Travel Expert",
    "rating": "8.0",
    "problem": "Nature and adventure scores overlap in basic relaxation packages.",
    "opportunity": "Strict category pairings for trek and sport bundles.",
    "rec": "Increase adventure weight factors on query results."
  },
  {
    "name": "Solo Travel Expert",
    "rating": "7.0",
    "problem": "Solo travelers recommended double-occupancy pricing models.",
    "opportunity": "Introduce single supplement calculations on base package pricing.",
    "rec": "Adjust estimated cost logic based on traveler count."
  },
  {
    "name": "Corporate Travel Expert",
    "rating": "6.5",
    "problem": "No invoicing or business expense documentation in checkout flows.",
    "opportunity": "Add a GST/Corporate ID field during checkout.",
    "rec": "Provide downloadable PDF invoices."
  },
  {
    "name": "International Travel Consultant",
    "rating": "7.2",
    "problem": "Visa policy default display is static and doesn't verify traveler passport nationality.",
    "opportunity": "Add passport nationality dropdown in questionnaire.",
    "rec": "Dynamic visa rule checks based on passport selection."
  },
  {
    "name": "Sales Manager",
    "rating": "7.0",
    "problem": "Leads dashboard doesn't sort by budget or follow-up urgency.",
    "opportunity": "Implement CRM pipeline board cards grouped by lead budget tier.",
    "rec": "Group CRM leads by deal values."
  },
  {
    "name": "CRM Manager",
    "rating": "6.8",
    "problem": "No automatic follow-up triggers or WhatsApp notification integration.",
    "opportunity": "Connect Twilio/WhatsApp API on lead submission.",
    "rec": "Add auto-trigger notification events."
  },
  {
    "name": "Operations Manager",
    "rating": "7.5",
    "problem": "Manually checking package versions when itinerary is generated is slow.",
    "opportunity": "Automate supplier price change mismatch warnings.",
    "rec": "Create alert system for stale package versions."
  },
  {
    "name": "Customer Support Lead",
    "rating": "7.0",
    "problem": "No instant support widget or chat box in itinerary pages.",
    "opportunity": "Embed real-time chat widgets linking directly to support team.",
    "rec": "Integrate WhatsApp chat overlay."
  },
  {
    "name": "SEO Specialist",
    "rating": "7.5",
    "problem": "Dynamic destination pages lack SEO schema markups.",
    "opportunity": "Add JSON-LD structure metadata for all cities and packages.",
    "rec": "Embed structural metadata on slug pages."
  },
  {
    "name": "Content Strategist",
    "rating": "7.0",
    "problem": "Destination overviews are basic text blocks.",
    "opportunity": "Incorporate local hidden gems blogs directly inside destination layouts.",
    "rec": "Include articles block in destination view."
  },
  {
    "name": "Growth Hacker",
    "rating": "6.5",
    "problem": "No referral bonus incentive system to drive viral invites.",
    "opportunity": "Offer travel discount vouchers for referral bookings.",
    "rec": "Introduce share-and-earn discount system."
  },
  {
    "name": "Analytics Expert",
    "rating": "7.2",
    "problem": "Funnel stats in admin panel are mocked arrays rather than live events.",
    "opportunity": "Track real-time page transition times using click events.",
    "rec": "Connect mixpanel or google analytics hooks."
  },
  {
    "name": "Solo Traveler",
    "rating": "7.8",
    "problem": "Feels lonely; no social group joining recommendations.",
    "opportunity": "Suggest group experiences or walking tours.",
    "rec": "Include social tags."
  },
  {
    "name": "Couple Traveler",
    "rating": "8.5",
    "problem": "Swapping hotels doesn't highlight romantic upgrade benefits.",
    "opportunity": "Show beautiful couples badges on 5-star upgrades.",
    "rec": "Tag romance hotels."
  },
  {
    "name": "Honeymoon Couple",
    "rating": "8.0",
    "problem": "No honeymoon greeting or welcome gift customization option.",
    "opportunity": "Add customizable room décor add-ons in bundle options.",
    "rec": "Embed upgrade choices."
  },
  {
    "name": "Family with Kids",
    "rating": "6.0",
    "problem": "T2_Q1 recommendations contain high-adventure white water rafting unsuitable for toddlers.",
    "opportunity": "Filter out extreme physical activities based on child age input.",
    "rec": "Validate age range against experience difficulty."
  },
  {
    "name": "Friends Group",
    "rating": "7.5",
    "problem": "No feature to split payments or vote on experiences.",
    "opportunity": "Introduce shared voting link for itinerary planning.",
    "rec": "Implement group itinerary editor."
  },
  {
    "name": "Luxury Traveler",
    "rating": "8.0",
    "problem": "Boutique hotels shown are below expectations.",
    "opportunity": "Exclude budget or 3-star ratings on luxury filters.",
    "rec": "Select luxury hotels strictly when slider is high."
  },
  {
    "name": "Budget Traveler",
    "rating": "8.5",
    "problem": "No warning about budget overrun when applying swaps.",
    "opportunity": "Display price difference clearly on alternative swap list.",
    "rec": "Add price delta badge on alternatives list."
  },
  {
    "name": "Senior Citizen",
    "rating": "6.2",
    "problem": "Text sizing is small and layout is physically demanding.",
    "opportunity": "Add ease of access controls (large fonts).",
    "rec": "Implement physical activity level check."
  },
  {
    "name": "Digital Nomad",
    "rating": "7.0",
    "problem": "No wifi speed or remote working hub recommendations.",
    "opportunity": "Highlight co-working cafes and high-speed internet hotels.",
    "rec": "Include work-friendly tags."
  },
  {
    "name": "Shopping Lover",
    "rating": "8.2",
    "problem": "Only basic malls listed; no local markets.",
    "opportunity": "Seed local markets in experiences list.",
    "rec": "Add local shopping guide."
  },
  {
    "name": "Food Explorer",
    "rating": "8.0",
    "problem": "No dietary restrictions filter (vegan, gluten-free, halal).",
    "opportunity": "Add dietary selection in profile.",
    "rec": "Filter restaurants by dietary labels."
  },
  {
    "name": "Adventure Seeker",
    "rating": "8.5",
    "problem": "No safety certifications shown for outdoor sports.",
    "opportunity": "Show operator safety badges.",
    "rec": "Add operator verification label."
  },
  {
    "name": "Parent Planning Family Vacation",
    "rating": "6.5",
    "problem": "No baby sitting or kid zone filter in hotel summary.",
    "opportunity": "List family-suited hotel features.",
    "rec": "Include kids-club flag."
  },
  {
    "name": "First-Time International Traveler",
    "rating": "7.0",
    "problem": "Visa instructions feel confusing.",
    "opportunity": "Add step-by-step visa support call bookings.",
    "rec": "Connect visa desk links."
  },
  {
    "name": "Quiet Traveler",
    "rating": "7.8",
    "problem": "Recommended noisy tourist hotspots.",
    "opportunity": "Prioritize off-the-beaten-path tag filters.",
    "rec": "Filter quiet slots."
  },
  {
    "name": "Culture Explorer",
    "rating": "8.2",
    "problem": "Museum descriptions lack historic background details.",
    "opportunity": "Include local expert audio guides.",
    "rec": "Add audio guide links."
  }
];
const logsCategories: Record<string, string[]> = {
  "Missing Features": [
